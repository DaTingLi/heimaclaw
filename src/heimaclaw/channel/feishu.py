...
from heimaclaw.channel.base import ChannelAdapter, InboundMessage
from heimaclaw.config.loader import get_config
from heimaclaw.console import agent_event, error, warning
...
class FeishuAdapter(ChannelAdapter):
    ...
    def __init__(
        ...
        self.verification_token = verification_token or feishu_config.verification_token
    ...
    def _encode_credentials(self) -> str:
        ...
        return credentials.encode().decode("utf-8").replace("\n", "")
